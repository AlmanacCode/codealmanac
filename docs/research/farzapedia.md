...
Rebuild _index.md with all articles and also: aliases
Rebuild _backlinks.json (Python script scanning [[wikilinks]])
...
How to Answer
Read _index.md. Scan for articles relevant to the query. Each entry has an also: field with aliases.
Check _backlinks.json to find articles that reference the topic. High backlink counts indicate central topics.
Read 3-8 relevant articles. Follow [[wikilinks]] and related: entries 2-3 links deep when relevant.
