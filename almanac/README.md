...
For the product boundary, read [Local-only Python product](decisions/local-only-python-product). For exact runtime paths, read [Local state layout](reference/local-state-layout).
