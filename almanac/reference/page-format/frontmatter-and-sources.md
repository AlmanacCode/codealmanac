...
[Page kinds](../../concepts/page-kinds) explains the related product vocabulary for concept, architecture, guide, decision, and reference pages. That vocabulary is not a current frontmatter identity field; the parser only models the supported fields listed here [@wiki_frontmatter] [@page-kinds].
